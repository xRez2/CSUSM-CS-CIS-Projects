...
int page_numPE; //added by X. the page number
...
public:
    ...
    int num_pages; // total number of logical pages in the system Added by X
    int num_frames;
    ...
    // Destructor
    ~PageTable();
  int size() const //added by X
    {
        return num_pages;
    }
int get_num_free_frames() const;
  // TODO: Add your implementation of the page table here
    void write_page_to_disk(int page_num);
    /**
